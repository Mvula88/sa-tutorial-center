...
VALUES
    ...
    (gen_random_uuid(), 'b2c3d4e5-f6a7-8901-bcde-f12345678901', 'center@absolute.edu.za', '{"sub": "b2c3d4e5-f6a7-8901-bcde-f12345678901", "email": "center@absolute.edu.za"}', 'email', NOW(), NOW(), NOW()),
    (gen_random_uuid(), 'c3d4e5f6-a7b8-9012-cdef-123456789012', 'staff@absolute.edu.za', '{"sub": "c3d4e5f6-a7b8-9012-cdef-123456789012", "email": "staff@absolute.edu.za"}', 'email', NOW(), NOW(), NOW());
...
(
    ...
    'absolute-tutorial',
    'info@absolute.edu.za',
    '+27 11 123 4567',
    '123 Education Street, Sandton',
    'Johannesburg',
    NULL,
    '#1E40AF',
    '#F59E0B',
...
(
    ...
    'excellence-learning',
    'info@excellence.edu.za',
    '+27 21 987 6543',
    '456 Academic Ave, Rondebosch',
    'Cape Town',
    NULL,
    '#059669',
    '#DC2626',
...
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'admin@tutorialcenter.com', 'Super Admin', '+27 82 000 0000', 'super_admin', NULL, TRUE),
('b2c3d4e5-f6a7-8901-bcde-f12345678901', 'center@absolute.edu.za', 'John Mokoena', '+27 82 111 1111', 'center_admin', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', TRUE),
('c3d4e5f6-a7b8-9012-cdef-123456789012', 'staff@absolute.edu.za', 'Maria Dlamini', '+27 82 222 2222', 'center_staff', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', TRUE);
...
('aaaaaaaa-1111-1111-1111-111111111111', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'Dr. Peter Nkosi', 'peter@absolute.edu.za', '+27 82 333 3333', 'male', 'PhD Mathematics', 'Mathematics, Statistics', '2022-01-15', 'active'),
('aaaaaaaa-2222-2222-2222-222222222222', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'Ms. Sarah Mbeki', 'sarah@absolute.edu.za', '+27 82 444 4444', 'female', 'MSc Physics', 'Physical Science', '2022-03-01', 'active'),
('aaaaaaaa-3333-3333-3333-333333333333', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'Mr. Thomas Zulu', 'thomas@absolute.edu.za', '+27 82 555 5555', 'male', 'BEd English', 'English, Literature', '2023-01-10', 'active'),
('aaaaaaaa-4444-4444-4444-444444444444', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'Mrs. Anna Botha', 'anna@absolute.edu.za', '+27 82 666 6666', 'female', 'BCom Accounting', 'Accounting, Business Studies', '2021-06-15', 'active');
...
('bbbbbbbb-1111-1111-1111-111111111111', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'ABS260001', 'Michael Molefe', 'michael@student.com', '+27 82 701 0001', 'male', '2008-03-15', 'Grade 12', 'King Edward VII School', '123 Student Lane', 'Joseph Molefe', '+27 82 801 0001', 'joseph@parent.com', 'Father', 'active'),
('bbbbbbbb-2222-2222-2222-222222222222', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'ABS260002', 'Emma Ndlovu', 'emma@student.com', '+27 82 701 0002', 'female', '2008-07-22', 'Grade 12', 'St. Andrews College', '456 Academic St', 'Grace Ndlovu', '+27 82 801 0002', 'grace@parent.com', 'Mother', 'active'),
('bbbbbbbb-3333-3333-3333-333333333333', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'ABS260003', 'David Sithole', 'david@student.com', '+27 82 701 0003', 'male', '2009-01-10', 'Grade 11', 'Pretoria Boys High', '789 Knowledge Ave', 'Peter Sithole', '+27 82 801 0003', 'peter.s@parent.com', 'Father', 'active'),
('bbbbbbbb-4444-4444-4444-444444444444', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'ABS260004', 'Sarah Mthembu', 'sarah.i@student.com', '+27 82 701 0004', 'female', '2009-05-18', 'Grade 11', 'Parktown Girls High', '321 Learning Rd', 'Martha Mthembu', '+27 82 801 0004', 'martha@parent.com', 'Mother', 'active'),
('bbbbbbbb-5555-5555-5555-555555555555', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'ABS260005', 'John Khumalo', 'john.n@student.com', '+27 82 701 0005', 'male', '2008-11-30', 'Grade 12', 'Jeppe High School', '654 Study Blvd', 'Elizabeth Khumalo', '+27 82 801 0005', 'liz@parent.com', 'Mother', 'active'),
('bbbbbbbb-6666-6666-6666-666666666666', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'ABS260006', 'Anna van Wyk', 'anna.h@student.com', '+27 82 701 0006', 'female', '2009-09-05', 'Grade 11', 'Hoerskool Linden', '987 Wisdom Way', 'James van Wyk', '+27 82 801 0006', 'james@parent.com', 'Father', 'active'),
('bbbbbbbb-7777-7777-7777-777777777777', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'ABS260007', 'Peter Mahlangu', 'peter.sh@student.com', '+27 82 701 0007', 'male', '2010-02-14', 'Grade 10', 'King Edward VII School', '147 Scholar St', 'Maria Mahlangu', '+27 82 801 0007', 'maria.sh@parent.com', 'Mother', 'active'),
('bbbbbbbb-8888-8888-8888-888888888888', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'ABS260008', 'Grace Pillay', 'grace.k@student.com', '+27 82 701 0008', 'female', '2010-06-25', 'Grade 10', 'St. Andrews College', '258 Education Ln', 'Thomas Pillay', '+27 82 801 0008', 'thomas.k@parent.com', 'Father', 'active');
...
('cacacaca-2222-2222-2222-222222222222', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'bbbbbbbb-2222-2222-2222-222222222222', 'fefefefe-2222-2222-2222-222222222222', 600.00, 'cash', NULL, 'Partial payment - balance R600', 'c3d4e5f6-a7b8-9012-cdef-123456789012', '2026-01-04'),
...
('cacacaca-5555-5555-5555-555555555555', 'd1e2f3a4-b5c6-7890-abcd-ef1234567890', 'bbbbbbbb-5555-5555-5555-555555555555', 'fefefefe-5555-5555-5555-555555555555', 900.00, 'bank_transfer', 'STD-2026-0015', 'January fees', 'b2c3d4e5-f6a7-8901-bcde-f12345678901', '2026-01-02'),
...
-- Center Admin: center@absolute.edu.za / password123
-- Staff: staff@absolute.edu.za / password123
