          ...
          <div className="flex flex-col items-center mt-12 pt-8 border-t border-gray-200">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg shadow-sm mb-4">
              ...
              <svg className="h-6" viewBox="0 0 60 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M59.64 14.28c0-4.56-2.22-8.16-6.48-8.16-4.26 0-6.84 3.6-6.84 8.1 0 5.34 3.06 8.04 7.44 8.04 2.16 0 3.78-.48 5.04-1.2v-3.54c-1.26.66-2.7 1.08-4.5 1.08-1.8 0-3.36-.66-3.54-2.88h8.88v-1.44zm-8.94-1.68c0-2.16 1.32-3.06 2.52-3.06 1.2 0 2.4.9 2.4 3.06h-4.92zM40.26 6.12c-1.8 0-2.94.84-3.6 1.44l-.24-1.14h-4.02v21.06l4.56-.96v-5.1c.66.48 1.62 1.14 3.24 1.14 3.24 0 6.24-2.64 6.24-8.34-.06-5.28-3.06-8.1-6.18-8.1zm-1.08 12.48c-1.08 0-1.74-.42-2.16-.9v-7.14c.48-.54 1.14-.96 2.16-.96 1.68 0 2.82 1.86 2.82 4.5 0 2.58-1.14 4.5-2.82 4.5zM24.78 5.34l4.62-.96V.96l-4.62.96v3.42zM24.78 6.54h4.62v15.36h-4.62V6.54zM20.28 7.98l-.3-1.44h-3.96v15.36h4.56v-10.5c1.08-1.38 2.88-1.14 3.48-.96V6.54c-.66-.24-2.7-.66-3.78 1.44zM11.22 2.46l-4.44.96-.02 14.1c0 2.58 1.92 4.5 4.56 4.5 1.44 0 2.52-.24 3.06-.54v-3.66c-.54.24-3.24 1.08-3.24-1.62V10.2h3.24V6.54h-3.24l.08-4.08zM2.64 11.1c0-.72.6-1.02 1.56-1.02 1.38 0 3.12.42 4.56 1.14V7.02c-1.5-.6-3.06-.84-4.56-.84C1.68 6.18 0 7.56 0 10.02c0 3.9 5.34 3.24 5.34 4.92 0 .84-.72 1.14-1.74 1.14-1.5 0-3.42-.66-4.92-1.5v4.32c1.68.72 3.36 1.02 4.92 1.02 2.58 0 4.38-1.26 4.38-3.78-.06-4.2-5.34-3.42-5.34-5.04z" fill="#635BFF"/>
              </svg>
            </div>
