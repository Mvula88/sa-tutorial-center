  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      if (studentError || !student) {
        ...
        setError('No student account found for this email. Please register first.')
        setIsLoading(false)
        return
      }
      ...
      if (student.status !== 'active') {
        await supabase.auth.signOut()
        setError('Your student account is not active. Please contact your tutorial center.')
        setIsLoading(false)
        return
      }

      // Redirect to student dashboard using their student ID
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/student/forgot-password" className="text-sm text-blue-600 hover:text-blue-700">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-center text-sm text-gray-600">
              ...
              <Link href="/student/register" className="text-blue-600 hover:text-blue-700 font-medium">
                Register here
              </Link>
            </p>
          </div>
